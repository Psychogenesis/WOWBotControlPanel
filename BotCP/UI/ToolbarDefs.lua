...
local ICONS = {
    ...
    dps_aoe     = "Interface\\Icons\\Spell_Fire_SelfDestruct",
    ...
    threat        = "Interface\\Icons\\Spell_Nature_Reincarnation",
    ...
    bthreat     = "Interface\\Icons\\Spell_Nature_Reincarnation",
    ...
    aoe         = "Interface\\Icons\\Ability_Whirlwind",
        ...
        buttons = {
            {
                ...
                description = "Bot follows your character",
                stateKey = "movement:follow",
                commandType = "action",
                command = "follow",
                icon = ICONS.follow,
            },
            {
                ...
                description = "Bot stays at current position",
                stateKey = "movement:stay",
                commandType = "action",
                command = "stay",
                icon = ICONS.stay,
            },
            {
                ...
                description = "Bot guards a specific location",
                stateKey = "movement:guard",
                commandType = "action",
                command = "guard",
                icon = ICONS.guard,
            },
            {
                ...
                description = "Bot grinds nearby enemies",
                stateKey = "movement:grind",
                commandType = "action",
                command = "grind",
                icon = ICONS.grind,
            },
            {
                ...
                description = "Bot flees from combat",
                stateKey = "movement:flee",
                commandType = "action",
                command = "flee",
                icon = ICONS.flee,
            },
            {
                ...
                description = "Bot avoids combat entirely",
                stateKey = "nc:passive",
                commandType = "strategy",
                channel = "nc",
        ...
        buttons = {
            {
                ...
                description = "Attack your current target",
                stateKey = nil,
                commandType = "action",
                command = "attack",
                icon = ICONS.attack,
            },
            {
                ...
                description = "Tank engages your target",
                stateKey = nil,
                commandType = "action",
                command = "tank attack",
            ...
            },
            {
                ...
                description = "Teleport bot to your location",
                stateKey = nil,
                commandType = "action",
                command = "summon",
                icon = ICONS.summon,
            },
            {
                ...
                description = "Resurrect at Spirit Healer",
                stateKey = nil,
                commandType = "action",
                command = "revive",
                icon = ICONS.revive,
            },
            {
                ...
                description = "Release spirit after death",
                stateKey = nil,
                commandType = "action",
                command = "release",
                icon = ICONS.release,
